...
{
    'name': 'SOHOVet Related Products',
    'version': '1.0',
    'category': 'Productos',
    'description': """Módulo que permite la manipulación de productos unitarios en Odoo.""",
    ...
    'data': [
        ...
        'wizard/related_product_wizard.xml',
        'data/virtual_location.xml',
    ],
    'active': False,
    'installable': True,
}
